...
class Assets {
  static late final Sprite leftButton;
  static late final Sprite rightButton;
  ...
  static Future<void> load() async {
    leftButton = Sprite(await Flame.images.load('left_button.png'));
    rightButton = Sprite(await Flame.images.load('right_button.png'));
